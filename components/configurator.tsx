...
import { Folder, FileText, Plus, Users, User, Settings, Trash2 } from "lucide-react"
...
export function Configurator({ onExit, toggleMode }: { onExit: () => void; toggleMode: () => void }) {
  ...
  const handleDeleteObject = () => {
    ...
    const collection = view.objectType === "catalog" ? "catalogs" : "documents"
    const updatedList = (metadata as any)[collection].filter((o: any) => o.id !== view.id)
